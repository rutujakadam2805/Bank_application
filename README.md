...
Database: MySQL
Build Tool: Maven
Architecture: Layered Architecture (Entity → DAO → Service → Main)
...
Hibernate ORM Mapping using Annotations
...
Entity Layer → Account, Transaction classes
DAO Layer → Handles database operations using Hibernate
Service Layer → Contains business logic
Main Layer → Console-based user interface
